...
export default function Navbar() {
  ...
  const getRoleBadgeClass = () => {
    switch (user?.role) {
      case "admin": return "bg-purple-500/30 text-purple-300 border-purple-500/30";
      case "teacher": return "bg-green-500/30 text-green-300 border-green-500/30";
      case "parent": return "bg-blue-500/30 text-blue-300 border-blue-500/30";
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {dropdownOpen && (
                <div className="absolute right-0 mt-3 w-72 backdrop-blur-xl bg-black border border-white/10 rounded-2xl shadow-2xl py-2 animate-in fade-in slide-in-from-top-2 duration-200">
                  <div className="px-4 py-3 border-b border-white/10 flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <span className={`inline-block mt-1 text-xs px-2.5 py-0.5 rounded-full border ${getRoleBadgeClass()}`}>
                        {getRoleLabel()}
                      </span>
                    </div>
                  </div>
